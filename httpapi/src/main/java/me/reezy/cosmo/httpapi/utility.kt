...
inline fun <T> Call<T>.onResponse(fragment: Fragment, noinline callback: (Response<T>) -> Unit) = ApiCall(this, fragment.lifecycleScope, Api.errorHandler, callback)
inline fun <T> Call<T>.onResponse(activity: FragmentActivity, noinline callback: (Response<T>) -> Unit) = ApiCall(this, activity.lifecycleScope, Api.errorHandler, callback)
